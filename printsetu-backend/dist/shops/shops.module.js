...
const admin_shops_controller_1 = require("./admin-shops.controller");
const shop_profile_controller_1 = require("./shop-profile.controller");
let ShopsModule = class ShopsModule {
};
exports.ShopsModule = ShopsModule;
exports.ShopsModule = ShopsModule = __decorate([
    (0, common_1.Module)({
        controllers: [admin_shops_controller_1.AdminShopsController, shop_profile_controller_1.ShopProfileController],
